...
export default function Layout({ headerStyle, footerStyle, headTitle, breadcrumbTitle, children, wrapperCls,imageUrl }) {
    ...
    return (
        <>
            ...
            <div className={`boxed_wrapper home_one ${wrapperCls ? wrapperCls : ""}`} id="#top">
                ...
                {headerStyle === 5 && <Header5 scroll={scroll} isMobileMenu={isMobileMenu} handleMobileMenu={handleMobileMenu} handlePopup={handlePopup} isSidebar={isSidebar} handleSidebar={handleSidebar} />}
