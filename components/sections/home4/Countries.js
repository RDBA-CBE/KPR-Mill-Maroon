  ...
  return (
    <section className="countries-style-five p_relative" >
      <div className="pattern-layer">
        <div className="pattern-1" style={{ backgroundImage: 'url(/assets/images/kprmill/home/shape-1.png)' }}></div>
        <div className="pattern-2" style={{ backgroundImage: 'url(/assets/images/kprmill/home/shape-2.png)' }}></div>
      </div>
        ...
        <div className="row clearfix">
            ...
            <div className="countries-block-five wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image"><img src="/assets/images/kprmill-images/Home-Page/whats-new.png" alt="" /></figure>
                </div>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 countries-block">
            <div className="countries-block-five wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image"><img src="/assets/images/kprmill-images/Home-Page/about-us.png" alt="" /></figure>
                </div>
                {/* <div className="lower-content">
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 countries-block">
            <div className="countries-block-five wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image"><img src="/assets/images/kprmill-images/Home-Page/awards.png" alt="" /></figure>
                </div>
                {/* <div className="lower-content">
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 countries-block">
            <div className="countries-block-five wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
              <div className="inner-box">
                <div className="image-box">
                  <figure className="image"><img src="/assets/images/kprmill-images/Home-Page/cert.png" alt="" /></figure>
                </div>
                {/* <div className="lower-content">
