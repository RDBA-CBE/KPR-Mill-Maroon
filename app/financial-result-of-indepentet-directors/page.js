...
export default function IndepentedDirectors() {
  ...
  const backgroundImage = "/assets/images/kprmill-images/Appointment-Of-Independent-Directors/banner.jpg";
  return (
    <>
      <Layout
        headerStyle={2}
        footerStyle={2}
        breadcrumbTitle="Appointment Of Independent Directors" imageUrl={backgroundImage}
      >
        {/* visa details section */}
        <section className="visa-details p_relative">
          <div className="auto-container">
