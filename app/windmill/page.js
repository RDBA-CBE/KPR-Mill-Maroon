...
export default function Windmill() {
  ...
  return (
    <>
      <Layout headerStyle={2} footerStyle={2} breadcrumbTitle="Windmill & Solar" imageUrl= {backgroundImage}>
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 order-lg-2 content-column">
                <div className="content_block_two">
                  <div className="content-box p_relative d_block">
                    ...
                    <div className="text mb_25">
                      <p>We also produce 40 MW of electricity through solar power units with future plans to increase our solar energy production. KPR is proud to exclaim that the captive power generated by us is consumed within all our factory premises.</p>
                    </div>
