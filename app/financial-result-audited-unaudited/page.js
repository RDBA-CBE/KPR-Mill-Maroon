...
export default function AuditedUnaudited() {
  ...
  const backgroundImage = "/assets/images/kprmill-images/Financial-Results/banner.jpg";
  return (
    <>
      <Layout
        headerStyle={2}
        footerStyle={2}
        breadcrumbTitle="Financial Results" imageUrl={backgroundImage}
      >
        {/* visa details section */}
        <section className="visa-details p_relative">
          <div className="auto-container">
            <div className="row clearfix">
              <div className="col-lg-4 col-md-12 col-sm-12 sidebar-side">
              <InvestorsSideMenu isActive="financial-result-audited-unaudited" />
              </div>
                  ...
                  <div className="content-one mb_45">
                    <div className=" table-responsive-sm">
                      <table class="table big-table table-striped">
                        <thead>
                          <tr>
                            <th colspan="2" style={{ backgroundColor: "#daad19", color: "white", fontSize: "18px" }}>Audited / Unaudited</th>
                          </tr>
                        </thead>
                        <tbody>
                          {Audited_Unaudited.map((item) => {
                            return (
                              <tr>
                                <td>
                                  {item.title}
