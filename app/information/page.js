...
//     try {
//       const groupedData = await groupedByYear("3791");
...
//     "/assets/images/kprmill-images/information/banner.jpg";
//   return (
//     <>
//       <Layout
//         headerStyle={2}
...
//               </div>
//               <ListComponents data={state.data} title="Information" />
//             </div>
//           </div>
//         </section>
//         {/*visa details end*/}
                    ...
                    <ul className="category-list clearfix">
                      ...
                      <li>
                        ...
                        <ul className="category-list clearfix">
                          ...
                          <li>
                            <Link href="/information" className="current">
                              Information
                            </Link>
                          </li>
                        </ul>
                  ...
                  <div className="content-one mb_45">
                    <div className=" table-responsive-sm">
                      <table class="table big-table table-striped table-bordered">
                        <thead>
                          <tr>
                            <th colspan="2" style={{ backgroundColor: "#daad19", color: "white", fontSize: "18px" }}>Information</th>
                          </tr>
                        </thead>
                        <tbody>
