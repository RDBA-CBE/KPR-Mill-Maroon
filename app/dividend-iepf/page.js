  ...
  const [state, setState] = useSetState({
    ...
    const getData = async () => {
      try {
        ...
        const res = await Models.auth.documentList(10);
    ...
    console.log("AuditedUnaudited data",state.data);
          ...
          <div className="auto-container">
            <div className="row clearfix">
              <div className="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                <InvestorsSideMenu isActive="dividend-iepf" />
              </div>
                      ...
                      >
                        ...
                        <div className=" table-responsive-sm">
                          {[...state.data?.entries()]?.map(([year, reports]) => ( 
                             ...
                             <thead>
                               <tr>
                                 <th colspan="2" style={{ backgroundColor: "#daad19", color: "white", fontSize: "18px" }}>Dividend / IEPF {year} </th>
                               </tr>
                             </thead>
                             <tbody>
                               {reports.map((report) => {
