...
export default function SubSidiaryCos() {
  ...
  const backgroundImage = "/assets/images/kprmill-images/Financials-Subsidiary-Cos/banner.jpg";
  return (
    <>
      <Layout
        headerStyle={2}
                  ...
                  <div className="content-one mb_45">
                    <div className=" table-responsive-sm">
                      <table class="table big-table table-striped">
                        <thead>
                          <tr>
                            <th colspan="2" style={{ backgroundColor: "#daad19", color: "white", fontSize: "18px" }}>Financials – Subsidiary Cos</th>
                          </tr>
                        </thead>
                        <tbody>
                          {Subsidary_cos.map((item) => {
                            return (
                              <tr>
                                <td>
                                  {item.title}
