  ...
  const [state, setState] = useSetState({
    ...
    const getData = async () => {
      try {
        ...
        const res = await Models.auth.documentList(14);
    ...
    console.log("Stock Exchange data",state.data);
                ...
                <div className="visa-details-content">
                  ...
                  >
                    ...
                    <table class="table  big-table table-striped">
                      ...
                      <thead>
                        <tr>
                          <th colspan="2" style={{ backgroundColor: "#daad19", color: "white", fontSize: "18px" }}>Stock Exchange Intimation {year} </th>
                        </tr>
                      </thead>
                      <tbody>
                        {reports.map((report) => (
