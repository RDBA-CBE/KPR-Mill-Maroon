                  ...
                  <div className="content-box p_relative d_block">
                    ...
                    <div className="text mb_25">
                        <ul className="about-list-style clearfix">
                            ...
                            <li>KPR has installed Windmills at diverse, strategic locations in Tamil Nādu with a capacity of 61.92 MW Green power generation(66 Windmills). </li>
                            <li>We also produce 40MW of electricity through solar power units with future plans to increase our solar energy production. </li>
